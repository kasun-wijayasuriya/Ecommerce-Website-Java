...
import com.ecommerce.util.SortValidator;
...
public class ProductController {
    ...
    private static final Set<String> ALLOWED_SORT_FIELDS = Set.of(
            "name", "price", "rating", "createdAt", "updatedAt", "brand"
    );
    ...
    public ResponseEntity<ApiResponse<Page<ProductResponse>>> getAllProducts(
        ...
        SortValidator.validateSortField(sortBy, ALLOWED_SORT_FIELDS);
        int effectiveSize = SortValidator.enforceMaxPageSize(size, MAX_PAGE_SIZE);
