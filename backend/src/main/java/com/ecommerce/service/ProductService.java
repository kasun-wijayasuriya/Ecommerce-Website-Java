...
public class ProductService {
    ...
    public ProductResponse createProduct(ProductRequest request) {
        ...
        Product product = Product.builder()
                .name(htmlSanitizerService.sanitize(request.getName()))
                .description(htmlSanitizerService.sanitize(request.getDescription()))
                .brand(htmlSanitizerService.sanitize(request.getBrand()))
    ...
    public ProductResponse updateProduct(String productId, ProductRequest request) {
        ...
        if (request.getName() != null) product.setName(htmlSanitizerService.sanitize(request.getName()));
        if (request.getDescription() != null) product.setDescription(htmlSanitizerService.sanitize(request.getDescription()));
        if (request.getBrand() != null) product.setBrand(htmlSanitizerService.sanitize(request.getBrand()));
