...
public class ReviewService {
    ...
    public ReviewResponse createReview(ReviewRequest request) {
        ...
        Review review = Review.builder()
                ...
                .title(htmlSanitizerService.sanitize(request.getTitle()))
                .comment(htmlSanitizerService.sanitize(request.getComment()))
    ...
    public ReviewResponse updateReview(String reviewId, ReviewRequest request) {
        ...
        if (request.getTitle() != null) review.setTitle(htmlSanitizerService.sanitize(request.getTitle()));
        if (request.getComment() != null) review.setComment(htmlSanitizerService.sanitize(request.getComment()));
