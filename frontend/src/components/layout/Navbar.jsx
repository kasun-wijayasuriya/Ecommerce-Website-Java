          ...
          <div className="md:hidden py-4 border-t border-gray-100 dark:border-gray-800">
            ...
            <div className="space-y-1">
              ...
              >
                <span>Wishlist</span>
                {wishlistCount > 0 && (
                  <span className="bg-red-100 dark:bg-red-900/30 text-red-600 px-2 py-0.5 rounded-full text-xs">
                    {wishlistCount}
                  </span>
                )}
              </Link>
              ...
              {isAuthenticated ? (
                <>
                  ...
                  {isAdmin() && (
                    <Link
                      to="/admin"
                      className="block px-4 py-3 rounded-xl text-sm font-medium text-primary-600 
                  ...
                  <button
                    onClick={handleLogout}
                    className="w-full text-left px-4 py-3 rounded-xl text-sm font-medium text-red-600 
                ...
                <div className="flex gap-3 px-4 pt-4">
                  <Link
                    to="/login"
                    className="flex-1 text-center py-2.5 border border-gray-300 dark:border-gray-600 
